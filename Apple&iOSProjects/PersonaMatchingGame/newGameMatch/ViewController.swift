...
class ViewController: UIViewController {
   ...
   //show method
    ...
    func endGame()
    {
        ...
        if matchCounter == 15
        {
            let alert = UIAlertController(title: "Wow your fast!!!", message: "Your time \(trueTime) Sec and \(globalCounter) taps", preferredStyle: UIAlertController.Style.alert)
            alert.addAction(UIAlertAction(title: "Play", style: UIAlertAction.Style.default, handler: {(action:UIAlertAction!) in
